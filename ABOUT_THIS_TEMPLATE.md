...
├── python_course_work_projects             # The main python package for the project
...
e.g: `cat python_course_work_projects/VERSION` will get the project version without harming
